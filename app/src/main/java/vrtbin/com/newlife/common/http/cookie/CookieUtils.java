...
public class CookieUtils {
  ...
  public static final String WEBVIEW_COOKIE_DOMAIN = "vrtbin.com";
  ...
  public static boolean domainMatches(String domain, String host) {
    ...
    /**
     * 匹配顶级域名，例如 host 是 baidu.com ，可以击中 .baidu.com 的 domain
     */
  ...
  /**
   * 去除重复的 cookie key ，会造成不同的 host 下相同的 cookie 覆盖。
   *
   * @param cookieList
   * @return
   */
  ...
  /**
   * 目前所有 WebView 内写入的 Cookie 都将种在 {@link WEBVIEW_COOKIE_DOMAIN} 这个 domain 下
   *
   * @param httpCookies
   */
